...
function wch_get_rest_url(string $route): string
{
    ...
    return esc_url_raw(home_url('/index.php?rest_route=' . $normalized_route));
}
...
function wch_enqueue_frontend_assets(): void
{
    ...
    wp_localize_script(
        ...
        'wchTracker',
        [
            'restUrl' => wch_get_rest_url('wch/v1/click'),
...
function wch_enqueue_admin_assets(string $hook): void
{
    ...
    wp_localize_script(
        ...
        'wchAdmin',
        [
            'heatmapUrl' => wch_get_rest_url('wch/v1/heatmap'),
            'defaultPath' => '/',
            'nonce' => wp_create_nonce('wp_rest'),
            'pages' => $page_options,
